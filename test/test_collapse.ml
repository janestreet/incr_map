...
let%test_module "[collapse_by] and [collapse_by_loosened_requirements] manual tests" =
  (module struct
...
let%test_module "[collapse_by] and [collapse_by_loosened_requirements] quickcheck tests" =
  (module struct
    module Two_ints : sig
